...
async def calculate_spread():
    ...
    # 等待两个任务完成，并获取结果
    s_first_price_apex, b_first_price_apex,s_first_size_apex,b_first_size_apex,s_fourth_pirce_apex,b_fourth_price_apex = await task1
    s_first_price_dydx, b_first_price_dydx,s_first_size_dydx,b_first_size_dydx,s_fourth_pirce_dydx,b_fourth_price_dydx = await task2
    return s_first_price_apex,b_first_price_apex,s_first_price_dydx,b_first_price_dydx,s_first_size_apex,b_first_size_apex,s_first_size_dydx,b_first_size_dydx,s_fourth_pirce_apex,b_fourth_price_apex,s_fourth_pirce_dydx,b_fourth_price_dydx    
